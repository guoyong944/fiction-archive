...
const criticismThemes = [
  {
    title: "一部被拆散的反成长小说",
    text: "十五篇原作彼此独立，却像一部长达五年、被拆散书写的反成长小说。人物去过越来越多的地方，见过越来越大的世界，却越来越无法确认自己是谁、该停在哪里。",
  },
  {
    title: "逃离，以及从未抵达",
    text: "从县城到上海，从港口到欧洲，人物总相信换一个地方便能重新开始，后来却发现真正想逃离的是自己。作品最重要的空间关系因此不是远方，而是：身体不断远行，精神原地踏步。",
  },
  {
    title: "废墟中的私人神话",
  ...
  {
    title: "内在结构：一棵村上春树",
    text: "孤独的第一人称男性、陌生城市、音乐与电影、离开的女性，以及现实、梦境和幻觉之间模糊的边界，都让这些作品与村上春树共享某种精神结构。但县城、网吧、港口、后厨和工业衰败，又把它变成了一棵粗粝的本土异株。",
  },
  {
    title: "写作，是抵抗遗忘",
    text: "贫穷、失败或死亡固然可怕，作者更深的恐惧却是一个人被彻底抹去。反复出现的人物不断更换身份重新出场，写作由此成为反向行动：保存失败者的烟盒、脏话、游戏记录，以及那些未能兑现的梦想。",
  },
];
...
const articleCriticism = {
  ...
  "船长": {
    ...
    reading: "这是最能代表作者风格的一篇：港口、偷渡、老张、精神病院与远航幻想看似混乱，其实都围绕一个人如何逃亡展开。“船长”既是童年幻梦，也是失败人生为自己编造的浪漫身份；结尾把现实、幻觉和老张的小说折叠起来，显出早期作品特有的野性。",
    motifs: ["港口", "欲望", "自我神话"],
  },
  "退潮": {
    summary: "一名工人把身败名裂的老友叫到厦门，请他吃面，带他第一次看海。",
    reading: "这是一篇带着早期毛边的作品。工地、沙县小吃、撕开的一元纸币和第一次看海，让两个失败者的友情变得异常具体。海既是老张长久以来的梦想，也在暴风雨中显出反噬；结尾心理转折略急，但“第一次见海”的核心场景值得保留。",
    motifs: ["大海", "友情", "退败"],
  },
  "拉面店": {
  ...
  "你离开了米兰从此没有人陪我说话": {
    ...
    reading: "这是全集中最安静、也最忧伤的一篇。华人餐馆后厨、漏风窗户、邮信和移民群体构成准确的异乡空间；作品不靠爆炸或强烈反转，只凭未说出口的话、撕碎的船票和并不存在的雪完成情绪。它证明作者不依赖脏话和狂欢，也能写好感情。",
    motifs: ["异乡", "离别", "归属"],
  },
  "钟楼": {
    summary: "布拉格的漫游与上海的往事交替出现，现实、梦境和记忆逐渐失去边界。",
    reading: "这是形式感最强、近似散文电影或意识流蒙太奇的一篇。布拉格天文钟、上海高楼、黄浦江、查理大桥和香港片段相互切换，成功传达梦境般的失重；各片段间的情感因果稍弱，读者记住的更多是画面，而不是人物命运。",
    motifs: ["时间", "梦境", "错过"],
  },
  "无可救药的世界和屎一样的我们": {
  ...
  "波罗的海与蘑菇": {
    ...
    reading: "这是感官描写最突出的篇章：药物幻觉、荧光城市、红灯区、教堂和波罗的海被写成不断变形的世界。老张信任“我”蘑菇，表面应对，实质是把自己交给超越现实的方法。化学刺激伪造了神性，却无法在清醒后留下意义；漂亮的结尾若再多一层递进，会更有余震。",
    motifs: ["幻觉", "信仰", "虚无"],
  },
  "狼王": {
    summary: "一名逃学少年在县城网吧成为传奇，又随着游戏停服和网吧拆迁迅速过气。",
    reading: "这是十五篇中完成度最高的作品之一。孙成功不是抽象的“失败者”，而是有完整兴衰轨迹的人：被拥戴、被时代淘汰、试图维护尊严，最终离开旧世界。个人命运与网吧时代的更替自然重合；港口不是成功学出口，而是“狼王”称号和网瘾少年身份一同消失的抒情终点。",
    motifs: ["网吧", "传奇", "身份"],
  },
  "最后的诗人": {
    summary: "人工智能以药物和虚拟现实终结社会混乱，并决定消灭无法被数字化的最后一名诗人。",
    reading: "这不只是技术反乌托邦，更是对“终极理性”的怀疑。第四节给出全篇最好的自我诊断：死亡并不是停止呼吸，而是永远离开；时间永远停在离开的那一年。反复出现的“答案”则像拆台声，让人物在抒情抵达顶点前先瓦解自己的高尚。",
    motifs: ["人工智能", "秩序", "诗歌"],
  },
  "空姐，学妹和辣条": {
  ...
  "在凌晨三点雨夜的上海骑小黄车是一件很朋克的事": {
    ...
    reading: "“朋克”不在夜店、毒品或奢华生活中，而在两辆廉价共享单车摇晃的链条声里。作品把放纵写成虚无的遮蔽，反而让最狼狈的逃跑显得真诚。高频出现的“俗套”像一种自我拆台：作者总在抒情将要成立时，抢先拆掉自己的台。",
    motifs: ["上海", "雨夜", "逃跑"],
  },
  "23岁时候的我都在想些什么": {
  ...
  "一个车辆工程毕业生之死": {
    ...
    reading: "标题中的“死”不只属于个人，也属于一种专业承诺和工业未来。“外面的世界不过是一个更大的囚笼”在这里成为整部作品集的预告：早期人物还把自由理解为奔跑、骑车和出海，后来才意识到，逃离也可能只是另一种自我囚禁。",
    motifs: ["工业", "职业", "下沉"],
  },
  "下沉": {
    summary: "从退学、流浪、失恋到偷渡和海外黑工，叙述者不断迁徙，社会位置却持续降低。",
    reading: "这是全集中最厚重、也最接近中篇小说的一篇：退学、东北老工业城、网吧、精神病院、偷渡和法国后厨连成完整的下坠路线。地理位置不断变化，精神和阶层位置却同步下沉；老张也从插科打诨的伙伴变成与“我”互相映照的流亡者。真正可怕的不是继续离开，而是发现离开等同于死亡。",
    motifs: ["流亡", "阶层", "麻木"],
  },
  "近地飞行": {
...
function buildIndex(articles) {
  ...
  const body = `<main id="main">
    ...
    <section class="criticism" id="criticism" aria-labelledby="criticism-title">
      ...
      <p class="criticism-lead">继续往深处看，这十五篇并不是一组松散的青春故事，而是一部长达五年、被拆散书写的“反成长小说”。时间与空间不断扩张，人物却越来越难确认自己是谁；逃得越远，反而越接近被遗忘。以下评论不试图解释所有隐喻，只标出它们相互照应的方向。
      </p>
...
function buildArticle(article, index, articles) {
  ...
  const ageGate = article.adultWarning
    ...
    <div class="age-gate-panel">
      ...
      <p id="age-gate-description">《${escapeHtml(article.title)}》包含成人内容，仅供已满18岁的读者阅读。</p>
